...
\section{By-laws}
  ...
  \subsection{Article I. Appointments}
    ...
    \subsubsection{Section 1. Webmaster}
      The board wishes to include in its officers the position of Web Master. His or her role will be to create and maintain a website for the Club.

    \subsubsection{Section 2. Information Officer}
      The board wishes to include in its officers the position of Information Officer. His or her role will be to keep the members informed about meetings and upcoming events and to invite dignitaries, company representatives and representatives of CSUSB organizations.

  \subsection{Article II. Duties}
    The duties of each officer position are to:
    ...
    \begin{description}
        ...
        \item[Secretary] ~\\
          ...
          \begin{itemize}
            ...
            \item Ensure meetings are effectively organized and minuted.
  ...
  \subsection{Article VII. Customs}
    ...
    -- Content of members done for the club is not their own intellectual property
